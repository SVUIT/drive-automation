      ...
      <nav className="px-3">
        <ul className="flex flex-col gap-2 list-none">
          <li>
            ...
            >
              <FileUp className={pathname === '/raw-uploads' ? 'text-brand-blue' : 'text-inherit'} size={20} />
          ...
          <li>
            ...
            >
              <Clock className={pathname === '/pending-approval' ? 'text-brand-blue' : 'text-inherit'} size={20} />
          ...
          <li>
            ...
            >
              <CheckCircle2 className={pathname === '/approved-files' ? 'text-brand-blue' : 'text-inherit'} size={20} />
