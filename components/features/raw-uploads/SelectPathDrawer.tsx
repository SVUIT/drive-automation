...
export default function SelectPathDrawer({ isOpen, onClose, file }: SelectPathDrawerProps) {
  ...
  const shortSemester = semester === "Học kỳ 1" ? "HK1" : semester === "Học kỳ 2" ? "HK2" : "HK Hè";
  ...
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed right-0 top-0 bottom-0 w-[400px] bg-white shadow-2xl z-50 p-8 flex flex-col overflow-y-auto transform transition-transform duration-300">
        <h2 className="text-blue-600 text-3xl font-extrabold text-center mb-8 tracking-tight">Select path</h2>

        <div className="space-y-5 flex-1">
          <div>
            <label className="block text-gray-600 font-semibold mb-2 text-sm">Subject</label>
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <label className="block text-gray-600 font-semibold mb-2 text-sm">Semester</label>
              <div className="relative">
                <select
                  value={semester}
            ...
            <div className="flex-1">
              <label className="block text-gray-600 font-semibold mb-2 text-sm">Year</label>
              <div className="relative">
                <select
                  value={year}
          ...
          <div>
            <label className="block text-gray-600 font-semibold mb-2 text-sm">Main content</label>
            <div className="relative">
              <select
                value={mainContent}
          ...
          <div>
            <label className="block text-gray-600 font-semibold mb-2 text-sm">Destination path</label>
            <div className="w-full bg-[#efefef] rounded-md p-4 text-gray-500 text-[13px] min-h-[100px] leading-relaxed break-words whitespace-pre-wrap">
